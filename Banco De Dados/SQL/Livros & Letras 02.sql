...
select nome, sum(itens_venda.quantidade) as total_livros_comprados from clientes left join vendas on id_cliente = id_clientefk left join itens_venda on id_venda = id_vendafk;
--arruma isso ai
-----------------------------------------------------------
